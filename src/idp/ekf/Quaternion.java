...
public class Quaternion {
	...
	public Quaternion times(Quaternion q1) {
		...
		newX = this.x * q1.r + this.r * q1.x - this.z * q1.y + this.y * q1.z;
		newY = this.y * q1.r + this.z * q1.x + this.r * q1.y - this.x * q1.z;
		newZ = this.z * q1.r - this.y * q1.x + this.x * q1.y + this.r * q1.z;
